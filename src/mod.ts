...
const QuestsLoader = require("./QuestsLoader");
const OnStartHandler = require("./OnStartHandler");
...
class CustomQuests {
  constructor() {
    ...
    this.config = config;
    this.questDirectory = path.join(
      __dirname,
      config.quest_directory || DEFAULT_QUESTS_DIR
    );
